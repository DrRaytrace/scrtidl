...
pro computecroissantwidth_idl8,halfangle_rad,leadingEdgeHeight_Rsun,aspectRatio
...
;wnd,1,800,1000
p0=plot(op2[*,0],op2[*,1]+h,aspect_ratio=1)
fu=plot(op[*,0],op[*,1]+h,line=1,/overplot)
fu=plot(op1[*,0],op1[*,1]+h,/overplot)

fu=polyline([[0,0],[op2[0,0],op2[0,1]+h]],/data,/overplot)
; plots,[0,0],/data
; plots,op2[0,0],op2[0,1]+h,/data,/continue


fu=polyline([[0,0],[op[0,0],op[0,1]+h]],/data,/overplot)
; plots,[0,0],/data
; plots,op[0,0],op[0,1]+h,/data,/continue,line=1

fu=polyline([[0,0],[op1[0,0],op1[0,1]+h]],/data,/overplot)
; plots,[0,0],/data
; plots,op1[0,0],op1[0,1]+h,/data,/continue


fu=polyline([[maxhalfwidth,heightatmax],[maxhalfwidth,heightatmax]],symbol='+',/data,/overplot)
